...
import java.util.List;
	...
	*/
    public class CommodityDiscountInfo implements Serializable
    {
		...
		*逻辑编号
		*/
		private String   _cDId;//逻辑编号
		/**
		*商品编号
		*/
		private String   _commodityInformationId;//商品编号
		/**
		*商家编号
		*/
		...
		*活动方式
		*/
		private String   _typeId;//活动方式
		/**
		*开始时间
		*/
		private String   _startDate;//开始时间
		/**
		*结束时间
		*/
		private String   _endDate;//结束时间
		/**
		*所需积分
		*/
		private int   _accumulativelntegra;//所需积分
		/**
		*所需等级
		*/
		private String   _level;//所需等级
		/**
		*折扣
		*/
		...
		*活动图片
		*/
		private String   _pictureListId;//活动图片
		/**
		*评价得分
		*/
		private String   _score;//评价得分
		/**
		*原价
		*/
		private Double   _oldPrice;//原价
		/**
		*活动价
		*/
		private Double   _newPrice;//活动价
		/**
		*预留字段
		*/
