...
import java.util.List;
	...
	*/
    public class ChatContentInfo implements Serializable
    {
		...
		*逻辑编号
		*/
		private String   _chatContentID;//逻辑编号
		/**
		*组编号
		*/
		private String   _groupID;//组编号
		/**
		*发送内容
		*/
		private String   _content;//发送内容
		/**
		*图片
		*/
		private String   _pictureListId;//图片
		/**
		*发送时间
		*/
		private String   _date;//发送时间
		/**
		*状态
		*/
		private String   _state;//状态
		/**
		*是否可以回复(0=false,1=true)
		*/
		private int   _ifReply;//是否可以回复(0=false,1=true)
		/**
		*预留字段
		*/
